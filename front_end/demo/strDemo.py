...
str = "sign=123456789"
dataDict = ParseXml.unpackXml(xml=xml, feature="xml")    # 拆包完成后
print(dataDict)

signStr = ParseXml.getSignStr(dataDict=dataDict)     # 拼接加签字符串
print(signStr)
...
newDataDict = ParseXml.updateDict(dataDict=dataDict, signKeyAndValue=signKeyAndValue)    # 加签后新拼装的Dict
print(newDataDict)

print("=====加签成功，准备发往第三方=====")
newXml = ParseXml.pack2Xml(newDataDict)
print("新的xml报文：" + newXml)

newDataDict1 = ParseXml.unpackXml(newXml, feature="xml")
