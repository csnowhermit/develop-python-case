...
from spider.util.tools import mkdir_if_missing, write_json, read_json
...
class Bilibili_Spider():
    ...
    def __init__(self, uid, save_dir_json='json', save_by_page=False, t=2):
        ...
        self.browser = webdriver.PhantomJS(executable_path='D:/opt/phantomjs-2.1.1-windows/bin/phantomjs.exe')
    ...
    def get(self):
        ...
        while self.page_num == 0:    # 循环重试，直到获取到页数
