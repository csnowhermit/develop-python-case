...
headers = {
    ...
    'referer': 'https://www.bilibili.com/video/BV1u3411Y73R?p=1'    # 跳过防盗链
}
...
if __name__ == '__main__':
    base_url = "https://www.bilibili.com/video/BV1u3411Y73R?p="
    save_path = "D:\dataset\spider_data\luoxiangjiangxingfa"
    for i in tqdm(range(1, 90)):
        html_data = send_request('https://www.bilibili.com/video/BV1u3411Y73R?p=%d' % i).text
