...
# for i in range(1, 29):
    # print("A", i, "号口\t找A", i, "检票口")
    # print("A", i, "口\t找A", i, "检票口")
    # print("B", i, "号口\t找B", i, "检票口")
    # print("B", i, "口\t找B", i, "检票口")
    # print("a", i, "号口\t找A", i, "检票口")
    # print("a", i, "口\t找A", i, "检票口")
    # print("b", i, "号口\t找B", i, "检票口")
    # print("b", i, "口\t找B", i, "检票口")
...
for i in range(20, 29):
    # print("C", i, "号口\t找C", i, "检票口")
    # print("C", i, "口\t找C", i, "检票口")
    # print("D", i, "号口\t找D", i, "检票口")
    # print("D", i, "口\t找D", i, "检票口")
    # print("c", i, "号口\t找C", i, "检票口")
    # print("c", i, "口\t找C", i, "检票口")
    # print("d", i, "号口\t找D", i, "检票口")
    # print("d", i, "口\t找D", i, "检票口")
