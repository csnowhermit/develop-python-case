                        ...
                        if n > 0:
                            ...
                            ## 有结果的页面
                                ...
                                for p1 in ps1:
                                    ...
                                    for line2 in lines2:
                                        if line2.startswith(
                                                '<script>FM.view({"ns":"","domid":"Pl_Official_PersonalInfo__59","css":["style/css/module/pagecard/PCD_text_b.css?version=97033aed3c17bc3f"]'):
                                            n2 = line2.find('html":"')
                                            if n2 > 0:
                                                ...
                                                for p2 in ps2:
                                                    ...
                                                    if (
                                                            infotype == infotype3 or infotype == infotype4 or infotype == infotype5 or infotype == infotype6):
